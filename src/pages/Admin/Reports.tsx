...
const REPORTS = [
  {
    id: '1',
    postTitle: 'React Hooks: useState, useEffect, useContext',
    postId: '2',
    reporter: 'Lê Văn X',
    reason: 'Nội dung sai kiến thức',
    reportedAt: '10/05/2026',
    type: 'post',
    status: 'pending',
    severity: 'medium',
  },
  {
    id: '2',
    postTitle: 'Bình luận vi phạm trên bài OOP',
    postId: '1',
    reporter: 'Trần Thị Y',
    reason: 'Ngôn ngữ không phù hợp',
    reportedAt: '09/05/2026',
    type: 'comment',
    status: 'pending',
    severity: 'high',
  },
  {
    id: '3',
    postTitle: 'SQL: JOIN và Optimization',
    postId: '3',
    reporter: 'Nguyễn Văn Z',
    reason: 'Spam / quảng cáo',
    reportedAt: '08/05/2026',
    type: 'post',
    status: 'resolved',
    severity: 'low',
  },
            ...
            >
              ...
              <div className={styles.reportContent}>
                ...
                <div className={styles.reportMeta}>
                  ...
                  <span>
                    🏷️ {report.type === 'post' ? 'Bài viết' : 'Bình luận'}
                  </span>
                </div>
