...
// src/.umi-production/api/subjects.ts
var subjects_exports = {};
__export(subjects_exports, {
  default: () => subjects_default
});
module.exports = __toCommonJS(subjects_exports);
...
async function handler(req, res) {
  ...
  try {
    const rows = await QuestionEntity.findAll({
      attributes: ["subject", [(0, import_sequelize3.fn)("COUNT", (0, import_sequelize3.col)("id")), "count"]],
      where: {
        status: { [import_sequelize3.Op.ne]: "hidden" },
        subject: { [import_sequelize3.Op.ne]: null }
      },
      group: ["subject"],
      order: [[(0, import_sequelize3.fn)("COUNT", (0, import_sequelize3.col)("id")), "DESC"]],
      raw: true
    });
...
var subjects_default = async (req, res) => {
