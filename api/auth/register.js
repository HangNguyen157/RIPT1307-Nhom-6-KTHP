...
var import_sequelize, dbName, dbUser, dbPassword, dbHost, dbPort, sequelize, isInitialized;
var init_db = __esm({
  "src/server/db.ts"() {
    "use strict";
    ...
    sequelize = new import_sequelize.Sequelize(dbName, dbUser, dbPassword, {
      host: dbHost,
      port: dbPort,
      dialect: "mysql",
...
var import_sequelize2, UserEntity, TagEntity, QuestionEntity, CommentEntity, VoteEntity;
var init_entities = __esm({
  "src/server/models/entities.ts"() {
    "use strict";
    import_sequelize2 = require("sequelize");
    init_db();
    UserEntity = class extends import_sequelize2.Model {
      id;
      name;
      email;
      password;
    ...
    UserEntity.init({
      id: { type: import_sequelize2.DataTypes.STRING, primaryKey: true },
      name: { type: import_sequelize2.DataTypes.STRING, allowNull: false },
      email: { type: import_sequelize2.DataTypes.STRING, allowNull: false, unique: true },
      password: { type: import_sequelize2.DataTypes.STRING, allowNull: true },
      role: { type: import_sequelize2.DataTypes.ENUM("student", "teacher", "admin"), defaultValue: "student" },
      department: { type: import_sequelize2.DataTypes.STRING, allowNull: true },
      major: { type: import_sequelize2.DataTypes.STRING, allowNull: true },
      studentId: { type: import_sequelize2.DataTypes.STRING, allowNull: true },
      avatar: { type: import_sequelize2.DataTypes.STRING, allowNull: true },
      bio: { type: import_sequelize2.DataTypes.TEXT, allowNull: true },
      reputation: { type: import_sequelize2.DataTypes.INTEGER, defaultValue: 10 },
      posts: { type: import_sequelize2.DataTypes.INTEGER, defaultValue: 0 },
      answers: { type: import_sequelize2.DataTypes.INTEGER, defaultValue: 0 },
      votes: { type: import_sequelize2.DataTypes.INTEGER, defaultValue: 0 },
      followers: { type: import_sequelize2.DataTypes.INTEGER, defaultValue: 0 },
      following: { type: import_sequelize2.DataTypes.INTEGER, defaultValue: 0 },
      joinDate: { type: import_sequelize2.DataTypes.STRING, allowNull: false },
      badges: {
      ...
      status: { type: import_sequelize2.DataTypes.ENUM("active", "banned"), defaultValue: "active" }
    }, {
      sequelize,
      modelName: "User",
      tableName: "Users",
    ...
    TagEntity = class extends import_sequelize2.Model {
      name;
      count;
      color;
      category;
    ...
    TagEntity.init({
      name: { type: import_sequelize2.DataTypes.STRING, primaryKey: true },
      count: { type: import_sequelize2.DataTypes.INTEGER, defaultValue: 0 },
      color: { type: import_sequelize2.DataTypes.STRING, allowNull: false, defaultValue: "#3b82f6" },
      category: { type: import_sequelize2.DataTypes.STRING, allowNull: false },
      desc: { type: import_sequelize2.DataTypes.TEXT, allowNull: true }
    }, {
      sequelize,
      modelName: "Tag",
      tableName: "Tags",
    ...
    QuestionEntity = class extends import_sequelize2.Model {
      id;
      title;
      excerpt;
      content;
    ...
    QuestionEntity.init({
      id: { type: import_sequelize2.DataTypes.STRING, primaryKey: true },
      title: { type: import_sequelize2.DataTypes.STRING, allowNull: false },
      excerpt: { type: import_sequelize2.DataTypes.TEXT, allowNull: false },
      content: { type: import_sequelize2.DataTypes.TEXT, allowNull: false },
      authorId: { type: import_sequelize2.DataTypes.STRING, allowNull: false },
      votes: { type: import_sequelize2.DataTypes.INTEGER, defaultValue: 0 },
      commentsCount: { type: import_sequelize2.DataTypes.INTEGER, defaultValue: 0 },
      views: { type: import_sequelize2.DataTypes.INTEGER, defaultValue: 0 },
      subject: { type: import_sequelize2.DataTypes.STRING, allowNull: true },
      isSolved: { type: import_sequelize2.DataTypes.BOOLEAN, defaultValue: false },
      status: { type: import_sequelize2.DataTypes.ENUM("active", "reported", "hidden"), defaultValue: "active" },
      createdAt: { type: import_sequelize2.DataTypes.DATE, defaultValue: import_sequelize2.DataTypes.NOW }
    }, {
      sequelize,
      modelName: "Question",
      tableName: "Questions",
    ...
    CommentEntity = class extends import_sequelize2.Model {
      id;
      questionId;
      parentId;
      authorId;
    ...
    CommentEntity.init({
      id: { type: import_sequelize2.DataTypes.STRING, primaryKey: true },
      questionId: { type: import_sequelize2.DataTypes.STRING, allowNull: false },
      parentId: { type: import_sequelize2.DataTypes.STRING, allowNull: true },
      authorId: { type: import_sequelize2.DataTypes.STRING, allowNull: false },
      votes: { type: import_sequelize2.DataTypes.INTEGER, defaultValue: 0 },
      isBest: { type: import_sequelize2.DataTypes.BOOLEAN, defaultValue: false },
      content: { type: import_sequelize2.DataTypes.TEXT, allowNull: false },
      createdAt: { type: import_sequelize2.DataTypes.DATE, defaultValue: import_sequelize2.DataTypes.NOW }
    }, {
      sequelize,
    ...
    VoteEntity = class extends import_sequelize2.Model {
      id;
      userId;
      targetId;
      targetType;
    ...
    VoteEntity.init({
      id: { type: import_sequelize2.DataTypes.STRING, primaryKey: true },
      userId: { type: import_sequelize2.DataTypes.STRING, allowNull: false },
      targetId: { type: import_sequelize2.DataTypes.STRING, allowNull: false },
      targetType: { type: import_sequelize2.DataTypes.ENUM("question", "comment"), allowNull: false },
      value: { type: import_sequelize2.DataTypes.INTEGER, allowNull: false }
    }, {
      sequelize,
      modelName: "Vote",
      tableName: "Votes",
...
// src/.umi-production/api/auth/register.ts
...
async function register(input) {
  ...
  if (exist) {
    throw new Error("Email n\xE0y \u0111\xE3 \u0111\u01B0\u1EE3c \u0111\u0103ng k\xFD s\u1EED d\u1EE5ng");
  }
