...
async function register(input) {
  ...
  if (exist) {
    throw new AuthError("Email n\xE0y \u0111\xE3 \u0111\u01B0\u1EE3c \u0111\u0103ng k\xFD s\u1EED d\u1EE5ng", 409);
  }
...
function validateRegisterInput(data) {
  ...
  if (!data.name || !isValidName(data.name)) {
    errors.push({
      field: "name",
      message: "T\xEAn ph\u1EA3i c\xF3 t\u1EEB 2 \u0111\u1EBFn 100 k\xFD t\u1EF1"
    });
  }
  if (!data.email || !isValidEmail(data.email)) {
    errors.push({
      field: "email",
      message: "\u0110\u1ECBnh d\u1EA1ng email kh\xF4ng h\u1EE3p l\u1EC7"
    });
  }
  if (!data.password || !isValidPassword(data.password)) {
    errors.push({
      field: "password",
      message: "M\u1EADt kh\u1EA9u ph\u1EA3i c\xF3 \xEDt nh\u1EA5t 8 k\xFD t\u1EF1, bao g\u1ED3m: ch\u1EEF hoa, ch\u1EEF th\u01B0\u1EDDng, s\u1ED1"
    });
  }
